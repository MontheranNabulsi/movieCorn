...
![MoviesCorn](https://images.unsplash.com/photo-1489599511996-1a1fb77fd59e?w=1200&h=400&fit=crop&crop=center)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/MontheranNabulsi/moviescorn.git
   cd moviescorn
   ```
